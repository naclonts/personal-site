...
import os
from . import secret_settings # pylint-ignore no-name-in-module
...
STATICFILES_DIRS = (
    ...
    # Join highlight.js for syntax highlighting CSS
    os.path.join(BASE_DIR, 'node_modules', 'highlight.js')
)
